...
<html lang="en">
	<head>
    <meta charset="utf-8">
    <link rel="shortcut icon" href="$baseUrl/../Images/logo.jpg" type="image/x-icon">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
      <a class="navbar-brand d-flex align-items-center" href="../index.php">
        <img src="../images/logo.JPG" class="logo-image" width="50" height="50">
        <h3 class="text-light text-uppercase ml-2">Sva College</h3>
      </a>
